...
import { LayoutDashboard, Users, Package, Receipt, BarChart3 } from 'lucide-react'
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex flex-col items-center justify-center gap-0.5 min-w-[56px] h-full px-3 transition-colors ${
